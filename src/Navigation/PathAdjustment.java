...
public class PathAdjustment {
    ...
    public boolean isEasy(Point ballCoordinate, Point roboPos){
        return (!isInCorner(ballCoordinate) && !isNearCross(ballCoordinate) && isBallInField(ballCoordinate) && !isInRange(roboPos, ballCoordinate) && !isNearSide(ballCoordinate) && !isAroundCross(ballCoordinate));
    }
